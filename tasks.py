...
from utils.utils import DEFAULT_DURATION, TEXT_WRITE, DIR_NAME, SOME_FILE_NAME, get_logger
...
def write_to_file() -> None:
    ...
    with open(SOME_FILE_NAME, 'a', encoding='UTF-8') as f:
        f.writelines([f'write text: {text}\n' for text in TEXT_WRITE])
...
def get_whether() -> None:
    """Функция получения прогноза погоды по Москвe."""
